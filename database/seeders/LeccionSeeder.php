...
class LeccionSeeder extends Seeder
{
    public function run()
    {
        $lecciones = [
            // Lecciones para A1
            ['nombre' => 'Nuevas Palabras', 'descripcion' => 'Incrementar vocabulario básico.', 'nivel_id' => 1],
            ...
            // Lecciones para A2
            ['nombre' => 'frutas, animales y palabras de uso diario', 'descripcion' => 'Frases de uso cotidiano en inglés.', 'nivel_id' => 2],
            ['nombre' => 'Direcciones y ubicaciones', 'descripcion' => 'Cómo preguntar y dar indicaciones.', 'nivel_id' => 2],
            ['nombre' => 'Tiempos del verbo', 'descripcion' => 'Presente simple y continuo.', 'nivel_id' => 2],

            // Lecciones para B1
            ['nombre' => 'Conversaciones simples', 'descripcion' => 'Cómo entablar una conversación básica.', 'nivel_id' => 3],
            ['nombre' => 'New words', 'descripcion' => 'Hablar sobre nuevas actividades.', 'nivel_id' => 3],
            ...
            // Lecciones para C1
            ['nombre' => 'Presentaciones en publico', 'descripcion' => 'Hablar en público de manera efectiva.', 'nivel_id' => 5],
            ...
            ['nombre' => 'Conversaciones formales', 'descripcion' => 'Aplicaciones del inglés en el trabajo.', 'nivel_id' => 6],
        ];
